package com.zero1tec.portfolio.ui.fragment.srttings;
...
import com.zero1tec.portfolio.databinding.RowSettingsBinding;
import com.zero1tec.portfolio.model.setting.Options;
...
public class OptionAdapter extends RecyclerView.Adapter<OptionAdapter.OptionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OptionAdapter.OptionViewHolder holder, final int position) {
        holder.binding.setModel( optionsList.get(position));
